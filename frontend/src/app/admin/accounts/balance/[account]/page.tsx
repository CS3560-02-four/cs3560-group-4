    ...
    return (
        <div className="relative top-32 flex justify-center">
            <form action={action} className="flex flex-col gap-4 shadow-md rounded p-5">
                <div className="text-3xl font-medium text-green-900 self-center">Account #{params.account}</div>
                ...
                <input className="w-0 h-0" type="text" value={params.account} name="accountId" onChange={() => {}}/>
            </form>
        </div>
    );
}